...
x = array([0., 0.1, 0.2, 0.37, 0.5, 0.55, 0.65, 0.77, 0.9])       # input
y = array([10.6, 16.0, 45.0, 83.5, 92.8, 109.9, 99.8, 109., 4.7])
n = 9;                                           # Number points in table
Nfit = 15;                                     # Number of interpolations
